...
public class BigDecimalUtil {
    ...
    public static double divide(Integer v1,double v2, int scale){
        if(v1==null)
            return 0;
        return divide(v1, v2, scale, BigDecimal.ROUND_HALF_UP);
    }
    ...
    public static String divide(String v1, String v2, int scale){
        return divide(v1, v2, DEFAULT_SCALE, BigDecimal.ROUND_HALF_UP);
    }
    ...
    /**
     * 保留2位小数四舍五入处理,舍入模式采用ROUND_HALF_UP
     * @param v 需要四舍五入的数字
     * @return 四舍五入后的结果
     */
